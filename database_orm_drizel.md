============================================================
QUICKCOURT — DRIZZLE + POSTGRESQL SETUP
============================================================
...
DATABASE_URL="postgresql://postgres:password@localhost:5432/quickcourt"
...
Slots are calculated dynamically from:

court opening/closing hours
+
existing bookings
+
court blocks
...
For the first local development cycle, `db:push` is faster.
